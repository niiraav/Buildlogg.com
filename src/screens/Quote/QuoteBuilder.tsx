            ...
            <div className="flex flex-wrap gap-1.5 mt-2">
              ...
              {items.filter((i) => i.description.trim() && i.amountNum > 0 && !isInLibrary(i.description, i.amountNum)).slice(0, 1).map((item) => (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 h-9 px-3 rounded-full bg-brand-primary text-brand-primaryText text-sm font-medium cursor-pointer hover:opacity-90 active:opacity-80 transition-opacity"
                >
