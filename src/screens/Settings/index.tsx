...
import { AlertTriangle, ChevronRight, ExternalLink, HelpCircle, MessageCircle, MessageSquare, Moon, Sun, Upload, FileText, Info, CreditCard, Check, Crown } from 'lucide-react';
    ...
    <div className="bg-[var(--app-shell-bg)] flex flex-col min-h-[100dvh]">
      ...
      <div className="px-4 md:px-6 pt-4 md:pt-6 pb-[calc(44px + env(safe-area-inset-bottom))]">
        ...
        <div className="mb-6">
          ...
          {isPro ? (
            /* Pro plan — gradient icon card, tappable to see features page */
            <button
            ...
            >
              <div className="px-4 py-3.5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: 'linear-gradient(135deg, #1e40af 0%, #3b82f6 60%, #60a5fa 100%)' }}>
                    <Crown size={18} className="text-white" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-bold text-brand-black">Pro</span>
                      <span className="text-[10px] font-bold tracking-wide text-white px-1.5 py-0.5 rounded-full" style={{ background: 'linear-gradient(135deg, #3b82f6, #60a5fa)' }}>
