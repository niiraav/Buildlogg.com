...
const DEFAULT_TEMPLATES: Array<Omit<MessageTemplate, 'id' | 'user_id' | 'created_at' | 'updated_at' | '_sync_status'>> = [
  {
    ...
    body: 'Hi {firstName}, your {jobTitle} is confirmed for {date} at {time}. I\'ll be at {address}. See you then!\n— {businessName}',
    is_default: true,
    sort_order: 0,
  },
  {
    ...
    body: 'Hi {firstName}, just a reminder I\'m coming tomorrow at {time} for the {jobTitle}.\n— {businessName}',
    is_default: true,
    sort_order: 1,
  },
  {
    ...
    body: 'Hi {firstName}, the balance of {amount} is now due for the {jobTitle}. Please arrange payment at your earliest convenience. Thanks!\n— {businessName}',
    is_default: true,
    sort_order: 2,
  },
  {
    ...
    body: 'Hi {firstName}, just following up on the quote I sent for the {jobTitle}. Happy to answer any questions.\n— {businessName}',
    is_default: true,
    sort_order: 3,
  },
  {
    category: 'review',
    name: 'Review request',
    body: 'Hi {firstName}, glad the {jobTitle} is sorted! If you were happy with the work, a quick Google review helps me a lot. Only takes 30 seconds. Thanks!\n— {businessName}\n\n{reviewLink}',
    is_default: true,
    sort_order: 4,
  },
  {
    ...
    body: 'Hi {firstName}, payment of {amount} for {jobTitle} has been confirmed. Thanks for your business!\n— {businessName}',
    is_default: true,
    sort_order: 5,
  },
  {
    category: 'update',
    name: 'Job update',
    body: 'Hi {firstName}, just an update on your {jobTitle}.\n— {businessName}',
    is_default: true,
    sort_order: 6,
  },
  {
    ...
    body: 'Hi {firstName}, your {jobTitle} is due soon. Book your next appointment: {bookingLink}\n— {businessName}',
    is_default: true,
    sort_order: 7,
  },
];
